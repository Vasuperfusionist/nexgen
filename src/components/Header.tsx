  ...
  return (
    ...
    >
      ...
      >
        <div className="container mx-auto">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col justify-center -space-y-0.5">
              ...
              <span className="text-white/90 font-semibold text-xs md:text-sm leading-tight" style={{ marginLeft: '1.15rem' }}>
                Healthcare
              </span>
            </div>
          </Link>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-2 border-t border-white/20 pt-2 mx-4 mb-4 shadow-xl"
            style={{
              background: 'linear-gradient(135deg, rgba(0, 123, 138, 0.98) 0%, rgba(65, 105, 225, 0.98) 50%, rgba(25, 25, 112, 0.98) 100%)'
            }}>
